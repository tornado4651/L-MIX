package com.tornado4651.lmix.cloud.data.kafka.message;

import com.tornado4651.lmix.cloud.data.kafka.message.handler.DefaultMsgHandler;
import com.tornado4651.lmix.cloud.data.kafka.message.handler.MsgHandler;
